...
**Answer** Describe the changes from the previous map
At first, when hovering the cursor on the area, it will show the labels with the FIPS code and a percentage with several decimals, but after customizing the tooltips, it shows the labels with County names and a percentage with one decimal.   
