...
**Answer** Copy the url of the graphic you published here. It will begin with <https://datawrapper.dwcdn.net/>. Don't copy the browser's current url. https://www.datawrapper.de/_/fXJUK/ 
...
md_gov_county <- md_gov_county |>
  ...
  mutate(percentage_moore = Moore/Total *100)
...
From the full U.S. map, the map is cropped to show only the Maryland territory, and the other polygons that don't represent data are hidden.
...
**Answer** Describe the changes from the previous map
AAt first, when hovering the cursor on the area, it will show the labels with the FIPS code and a percentage with several decimals, but after customizing the tooltips, it shows the labels with County names and a percentage with one decimal.   
...
**Answer** Put the URL of your map here. https://www.datawrapper.de/_/Iy0la/ 
