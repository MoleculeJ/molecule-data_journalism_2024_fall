...
**Answer**
The restaurants having the same name cannot be groped properly because: 
- they are written in different cases (some are lowercase and some are uppercase).
- some of them are misspelled. 
- some of them include symbols like commas, and apostrophes,  while others opt out of the symbol. 
- some of them include specific information like the street where the restaurant is while the others just mention only the restaurant's name. 
- they are written using different formats (some use the symbol "&" but some use the word "and"). 
...
**Answer**
- It adjusts a name, SCARLET PAK, from being written in the uppercase style to being written in the title case style.
(I see one change from the first 20 rows so I look further)
- It adjusts a name, Georgetown Cupcake, from being in the title case style to being in the uppercase style. 
...
**Answer**
- It changes some names written in the title case style to be the uppercase names.
- It also changes some names written in uppercase style to the title case names. 
- It changes the way some names are written to be the different ones (such as changing 'W. Millar & Co.' to 'W. MILLAR & CO. CATERING')
...
**Answer**
Judging from the first 20 rows, I think both methods do the same thing. 
