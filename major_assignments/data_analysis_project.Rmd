...
regis_population_congress_primary_24 <- bind_cols(total_congress_primary_24, congress_population) |>
  mutate(Percent = (TOTAL/population)*100)
#General24
total_congress_general_24 <- congress_general_24 |>
  select(District, TOTAL)
regis_population_congress_general_24 <- bind_cols(total_congress_general_24, congress_population) |>
  mutate(Percent = (TOTAL/population)*100)

#Compare to Election Result
```